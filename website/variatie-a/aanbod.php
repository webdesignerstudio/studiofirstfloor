...
<main>
    <section style="padding-top: 150px; padding-bottom: 60px;">
        <div class="container">
            <div class="reveal">
                ...
                <h1 style="text-align: center;">Aanbod</h1>
            </div>
        </div>
    </section>
    ...
    <section style="padding-top: 0;">
        <div class="container">
            ...
            <div style="margin-top: 80px; text-align: center;" class="reveal">
                <p class="section-label" style="margin-bottom: 24px;">Werkwijze</p>
                <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 24px; max-width: 900px; margin: 0 auto;">
                    ...
                    <div style="padding: 24px;">
                        <h4 style="margin-bottom: 8px;">Persoonlijke aandacht</h4>
                        <p style="font-size: 0.9rem; margin: 0;">Professionele begeleiding op jouw niveau</p>
                    </div>
                    <div style="padding: 24px;">
                    ...
                    <div style="padding: 24px;">
                        <h4 style="margin-bottom: 8px;">Materialen aanwezig</h4>
                        <p style="font-size: 0.9rem; margin: 0;">Matten, props en alle benodigdheden</p>
                    </div>
                    <div style="padding: 24px;">
                        <h4 style="margin-bottom: 8px;">Lounge</h4>
                        <p style="font-size: 0.9rem; margin: 0;">Gratis koffie en thee na je les</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            ...
            <div class="card-grid two-col reveal">
                <div style="border: none; padding: 0;">
                    <img src="img/studio-3.jpg" alt="Studio interieur" style="width: 100%; height: 350px; object-fit: cover;">
                </div>
                <div style="border: none; padding: 0;">
                    <img src="img/studio-1.jpg" alt="Pilates materiaal" style="width: 100%; height: 350px; object-fit: cover;">
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="cta-section">
        <div class="container reveal">
            ...
            <p style="margin-bottom: 30px;">Neem contact met ons op voor persoonlijk advies.</p>

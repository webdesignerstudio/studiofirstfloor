            ...
            <form method="POST" action="opslaan-bevestiging.php">
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group full">
                        ...
                        <textarea id="bev_bericht" name="bev_bericht"><?= htmlspecialchars($smtp['bev_bericht'] ?? "Hartelijk dank voor uw aanvraag. Wij hebben uw bericht in goede orde ontvangen en gaan er direct mee aan de slag. Binnen 1 werkdag nemen wij contact met u op om de mogelijkheden te bespreken.") ?></textarea>

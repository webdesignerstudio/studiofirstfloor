...
<head>
    ...
    <link rel="icon" type="image/png" sizes="1024x1024" href="/favicon.png?v=7">
...
?>
    ...
    <link rel="preload" href="css/style.min.css?v=17" as="style">
    <link rel="stylesheet" href="css/style.min.css?v=17">
    <noscript>
        <style>
